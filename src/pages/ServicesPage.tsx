      ...
      <section className="relative min-h-[48vh] sm:min-h-[52vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-[#062316]">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Soluciones Inmobiliarias Integrales en Lima - Megapolys Inmobiliaria" 
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-6">
          ...
          >
            ...
            <span>/</span>
            <span className="text-[#A3D224] font-semibold">Servicios</span>
          </motion.div>
        </div>
      </section>
            ...
            {services.map((service, idx) => (
              ...
              >
                ...
                <Link to={`/servicios/${service.id}`} className="block relative aspect-[16/11] rounded-2xl overflow-hidden shadow-sm bg-slate-100">
                  ...
                  <div className="absolute bottom-3 right-3 w-10 h-10 rounded-xl bg-[#00873D] text-white flex items-center justify-center shadow-lg group-hover:bg-[#007333] transition-colors">
                    {getServiceIcon(idx)}
                  </div>
                </Link>
                ...
                <div className="pt-4">
                  <Link to={`/servicios/${service.id}`}>
                    <h3 className="text-xl font-bold text-slate-900 group-hover:text-[#00873D] transition-colors mb-2 leading-snug">
                      {service.title}
                    </h3>
                  </Link>

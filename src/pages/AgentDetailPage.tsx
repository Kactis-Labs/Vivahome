...
export const AgentDetailPage: React.FC = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hola ${agent.name}, deseo agendar una consulta personalizada con usted sobre oportunidades inmobiliarias en VivaHome.`
  );
  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-[44vh] sm:min-h-[48vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-[#0B1E17]">
        {/* Background Image with Dark Architectural Overlay */}
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=2000&auto=format&fit=crop" 
            alt="Asesor Inmobiliario VivaHome" 

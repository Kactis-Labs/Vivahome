...
export const AgentDetailPage: React.FC = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hola ${agent.name}, deseo agendar una consulta personalizada con usted sobre oportunidades de inversión y asesoría en GyS Servicios Inmobiliarios.`
  );
  ...
  return (
    ...
    >
      ...
      {/* 1. HERO BANNER */}
      <section className="relative min-h-[44vh] sm:min-h-[48vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-[#0C130E]">
        {/* Background Image with Dark Architectural Overlay */}
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=2000&auto=format&fit=crop" 
            alt="Asesor Especialista GyS Servicios Inmobiliarios" 
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-6">
          ...
          >
            ...
            <span>/</span>
            <span className="text-lime-400 font-medium truncate max-w-[200px]">{agent.name}</span>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            >
              ...
              <motion.a 
                ...
                className="w-full bg-lime-500 hover:bg-lime-400 text-black font-semibold text-sm py-3.5 px-6 rounded-full flex items-center justify-center gap-2 transition-all shadow-md"
              >
              ...
              {agent.skills && agent.skills.length > 0 && (
                ...
                >
                  <h3 className="text-xl font-medium tracking-tight text-zinc-900 mb-4">
                    Especialidades & Competencias Clave
                  </h3>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    {agent.career.map((stage, idx) => (
                      ...
                      >
                        <span className="text-sm font-bold text-lime-700 block font-mono">
                          {stage.period}
                        </span>
                        <p className="text-xs font-light text-zinc-600 leading-relaxed">
                          {stage.description}
              ...
              <div className="pt-4 border-t border-zinc-200">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <motion.a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-lime-500/15 hover:bg-lime-500 hover:text-black text-lime-800 text-xs font-medium transition-colors"
                  >
                  ...
                  <motion.a 
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-zinc-100 hover:bg-[#0C130E] hover:text-white text-zinc-700 text-xs font-medium transition-colors"
                  >

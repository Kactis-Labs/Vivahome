...
export const AgentDetailPage: React.FC = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hola ${agent.name}, deseo agendar una consulta personalizada con usted sobre oportunidades inmobiliarias en Golden Inmobiliaria.`
  );
      ...
      <section className="relative min-h-[44vh] sm:min-h-[48vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-[#1D4263]">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Asesor Inmobiliario Golden Inmobiliaria" 
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-6">
          ...
          >
            ...
            <span>/</span>
            <span className="text-amber-400 font-medium truncate max-w-[200px]">{agent.name}</span>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            >
              ...
              <motion.a 
                ...
                className="w-full bg-#E5A020 hover:bg-amber-600 text-white font-medium text-sm py-3.5 px-6 rounded-full flex items-center justify-center gap-2 transition-all shadow-md"
              >
              ...
              <div className="pt-4 border-t border-slate-200">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <motion.a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-slate-100 hover:bg-#E5A020 hover:text-white text-slate-700 text-xs font-medium transition-colors"
                  >

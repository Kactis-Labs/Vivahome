...
export const AgentDetailPage: React.FC = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hola ${agent.name}, deseo agendar una consulta personalizada sobre departamentos en venta con KC Inmobiliaria.`
  );
  ...
  return (
    ...
    >
      ...
      {/* 1. HERO BANNER */}
      <section className="relative min-h-[44vh] sm:min-h-[48vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-[#0A0A0A]">
        {/* Background Image with Dark Architectural Overlay */}
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=2000&auto=format&fit=crop" 
            alt="Asesor Inmobiliario KC Inmobiliaria" 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            >
              ...
              <motion.a 
                ...
                className="w-full bg-black hover:bg-zinc-800 text-white font-medium text-sm py-3.5 px-6 rounded-full flex items-center justify-center gap-2 transition-all shadow-md"
              >
            ...
            <div className="lg:col-span-7 space-y-10">
              ...
              >
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tight text-black leading-tight mb-4">
                  {agent.name}
                </h2>
              ...
              {agent.skills && agent.skills.length > 0 && (
                ...
                >
                  <h3 className="text-xl font-medium tracking-tight text-black mb-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    {agent.skills.map((skill, idx) => (
                      <motion.div 
                        key={idx}
                        whileHover={{ y: -3 }}
                        className="p-5 rounded-2xl bg-[#FAFAFA] border border-zinc-200 shadow-sm space-y-1.5 transition-all"
                      >
              ...
              <div className="pt-4 border-t border-zinc-200">
                <h3 className="text-base font-medium tracking-tight text-black mb-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <motion.a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-zinc-100 hover:bg-black hover:text-white text-zinc-800 text-xs font-medium transition-colors"
                  >

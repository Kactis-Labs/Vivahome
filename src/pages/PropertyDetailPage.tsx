...
export const PropertyDetailPage: React.FC = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hola ${property.assignedAgent.name}, estoy interesado(a) en la propiedad "${property.title}" (${property.price} / ${property.location}) a través de Golden Inmobiliaria. Deseo agendar una visita o recibir el brochure.`
  );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 mb-6 sm:mb-8 text-xs sm:text-sm font-light text-slate-500">
            <div className="flex items-center gap-1.5 sm:gap-2 overflow-hidden">
              <Link to="/" className="hover:text-amber-600 transition-colors shrink-0">
                Inicio
              </Link>
              <span>/</span>
              <Link to="/#deals" className="hover:text-amber-600 transition-colors shrink-0">
                Oportunidades
              </Link>
              <span>/</span>
            ...
            <button 
              onClick={() => navigate(-1)}
              className="inline-flex items-center gap-1.5 text-xs font-medium text-slate-700 hover:text-amber-600 bg-white border border-slate-200 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full transition-colors shadow-sm cursor-pointer ml-auto"
            >
          ...
          <div className="mb-6 sm:mb-8">
            <div className="flex flex-wrap items-center gap-2 mb-3 sm:mb-4">
              <span className="px-3 py-0.5 sm:px-3.5 sm:py-1 rounded-full bg-amber-100/70 border border-emerald-300 text-amber-800 text-[10px] sm:text-[11px] font-medium uppercase tracking-wider">
                VENTA EXCLUSIVA
              </span>
              {property.badge && (
                <span className="px-3 py-0.5 sm:px-3.5 sm:py-1 rounded-full bg-[#1D4263] text-white text-[10px] sm:text-[11px] font-medium uppercase tracking-wider">
                  {property.badge}
                </span>
              )}
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 sm:gap-6">
              <div>
                ...
                <p className="text-xs sm:text-base font-light text-slate-600 flex items-center gap-1.5 sm:gap-2">
                  <MapPin className="w-4 h-4 text-#E5A020 shrink-0" />
              ...
              <div className="lg:text-right shrink-0 pt-2 lg:pt-0">
                ...
                {property.pricePen && (
                  <div className="text-xs sm:text-sm font-medium text-amber-600 mt-0.5">
                    {property.pricePen}
                  </div>
                )}
          ...
          <div className="mb-10 sm:mb-14">
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-sm h-[260px] sm:h-[400px] lg:h-[580px] w-full bg-[#1D4263]">
              <img 
                src={property.image} 
                alt={property.title} 
              ...
              <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6 flex items-center justify-between text-white">
                <span className="bg-[#1D4263]/85 backdrop-blur-md px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-full text-[11px] sm:text-xs font-light border border-white/10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 text-xs sm:text-sm font-light text-slate-700 border-y border-slate-200 py-4 sm:py-6">
                  <div className="flex items-baseline gap-2">
                    <span className="text-#E5A020 font-bold">•</span>
            ...
            <div className="lg:col-span-4 w-full">
              <div className="lg:sticky lg:top-28 bg-white border border-slate-200 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-lg sm:shadow-xl space-y-5 sm:space-y-6">
                ...
                {/* Header Sidebar */}
                <div>
                  <span className="text-[10px] sm:text-[11px] font-medium text-amber-600 uppercase tracking-wider block mb-1">
                  ...
                  <p className="text-xs font-light text-slate-500 mt-1">
                    Completa el formulario o contacta directamente con el asesor asignado a esta propiedad en Golden Inmobiliaria.
                  </p>
                </div>
                ...
                <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-50 border border-slate-100 flex items-center gap-3">
                  <img 
                    ...
                    className="w-11 h-11 sm:w-13 sm:h-13 rounded-full object-cover ring-2 ring-#E5A020 shrink-0"
                  />
                  <div className="overflow-hidden">
                    ...
                    <a 
                      ...
                      className="text-[11px] sm:text-xs font-medium text-amber-600 flex items-center gap-1 mt-0.5 hover:underline"
                    >
                ...
                {/* Formulario */}
                {formSubmitted ? (
                  <div className="p-5 bg-amber-50 border border-emerald-200 rounded-2xl text-center space-y-2">
                    <CheckCircle2 className="w-8 h-8 text-#E5A020 mx-auto" />
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-3.5">
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-#E5A020 focus:bg-white"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs text-slate-900 focus:outline-none focus:border-#E5A020 focus:bg-white"
                      />
                    </div>

                    <button 
                      type="submit"
                      className="w-full bg-#E5A020 hover:bg-amber-600 text-white text-xs font-medium py-2.5 sm:py-3 rounded-full flex items-center justify-center gap-2 transition-colors shadow-sm cursor-pointer"
                    >
                ...
                <div className="pt-1">
                  <a 
                    ...
                    className="w-full bg-#E5A020 hover:bg-amber-600 text-white font-medium text-xs sm:text-sm py-3 px-4 rounded-full flex items-center justify-center gap-2 transition-all shadow-md hover:scale-102"
                  >
                ...
                <p className="text-[10px] sm:text-[11px] font-light text-slate-400 text-center leading-relaxed">
                  🔒 Tus datos están protegidos bajo estricta confidencialidad por Golden Inmobiliaria.
                </p>
          ...
          <div className="mt-16 sm:mt-24 pt-12 sm:pt-16 border-t border-slate-200">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 sm:mb-12 gap-3">
              <div>
                <span className="text-[11px] sm:text-xs font-medium text-amber-600 uppercase tracking-wider block mb-1">
                  RECOMENDADOS
                </span>
              ...
              <Link 
                to="/#deals"
                className="inline-flex items-center gap-1.5 text-xs font-medium text-slate-700 hover:text-amber-600"
              >
              ...
              {similarProperties.map((simProp) => (
                ...
                >
                  <div className="relative aspect-[16/11] overflow-hidden">
                    ...
                    {simProp.badge && (
                      <div className="absolute top-3 left-3 sm:top-4 sm:left-4 bg-#E5A020 text-white text-[9px] sm:text-[10px] font-medium px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full uppercase tracking-wider">
                        {simProp.badge}
                      </div>
                    )}
                  ...
                  <div className="p-4 sm:p-6 flex-1 flex flex-col justify-between">
                    <div>
                      <h3 className="text-sm sm:text-base font-medium text-slate-900 group-hover:text-amber-600 transition-colors mb-1 line-clamp-1">
                        {simProp.title}
                      </h3>
                      <p className="text-[11px] sm:text-xs font-light text-slate-500 flex items-center gap-1 mb-3 sm:mb-4">
                        <MapPin className="w-3 h-3 text-#E5A020 shrink-0" />
                    ...
                    <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-[11px] sm:text-xs font-light text-slate-600">
                      <div className="flex items-center gap-1">
                        <Bed className="w-3.5 h-3.5 text-#E5A020" />
                        <span>{simProp.beds} Dorm.</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <Bath className="w-3.5 h-3.5 text-#E5A020" />
                        <span>{simProp.baths} Baños</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <Maximize2 className="w-3.5 h-3.5 text-#E5A020" />

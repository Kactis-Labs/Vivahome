      ...
      <section className="relative min-h-[48vh] sm:min-h-[52vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-[#0D2218]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-6">
          ...
          >
            ...
            <span>/</span>
            <span className="text-emerald-400 font-medium">Detalle del Artículo</span>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 sm:mb-10">
            ...
            >
              ...
              <span>Volver a Artículos & Novedades</span>
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            >
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-2xl sm:rounded-3xl p-6 sm:p-7 space-y-4">

      ...
      <section className="relative min-h-[48vh] sm:min-h-[52vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-[#0C130E]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-6">
          ...
          >
            ...
            <span>/</span>
            <span className="text-lime-400 font-medium">Detalle del Artículo</span>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 sm:mb-10">
            ...
            >
              ...
              <span>Volver a Artículos & Guías</span>
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            >
              ...
              {/* Tarjeta 1: Detalles del Artículo */}
              <div className="bg-lime-500/10 border border-lime-500/20 rounded-2xl sm:rounded-3xl p-6 sm:p-7 space-y-4">
                <h3 className="text-lg font-medium text-zinc-900 tracking-tight">
                  Detalles del Artículo
                </h3>

                <div className="space-y-3.5 pt-1 text-xs sm:text-sm font-light text-zinc-700">
                  {/* Fecha */}
                  <div>
                    <span className="text-[10px] sm:text-[11px] font-medium text-zinc-500 uppercase tracking-wider block mb-1">
                      Fecha de Publicación
                    </span>
                    <div className="flex items-center gap-2 text-zinc-900 font-medium">
                      <Calendar className="w-4 h-4 text-lime-700 shrink-0" />
                      <span>{post.date}</span>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-zinc-900 font-medium">
                      <Tag className="w-4 h-4 text-lime-700 shrink-0" />
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-zinc-900 font-medium">
                      <Clock className="w-4 h-4 text-lime-700 shrink-0" />
                      <span>{post.readingTime || '5 Minutos'}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {post.author && (
                <div className="bg-[#F8FAFC] border border-zinc-200 rounded-2xl sm:rounded-3xl p-6 sm:p-7 shadow-sm space-y-4">
                  <h3 className="text-lg font-medium text-zinc-900 tracking-tight">
                    Autor
                  </h3>
                  ...
                  <div className="flex items-center gap-3.5">
                    <img 
                      ...
                      className="w-12 h-12 rounded-full object-cover ring-2 ring-lime-400 shrink-0"
                    />
                  ...
                  <p className="text-xs font-light text-zinc-600 leading-relaxed italic pt-2 border-t border-zinc-200">
                    "{post.author.quote}"
                  </p>
                </div>
              )}
            ...
            >
              ...
              {post.section1 && (
                <div>
                  ...
                  <div className="space-y-4 text-sm sm:text-base font-light text-zinc-700 leading-relaxed">
              ...
              {/* Imagen Intermedia */}
              {post.middleImage && (
                <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-sm my-6 sm:my-8 bg-zinc-100">
                  <img 
              ...
              {post.section4 && (
                <div>
                  ...
                  <ol className="space-y-2.5 text-xs sm:text-sm font-light text-zinc-700 leading-relaxed list-none">
                    {post.section4.items.map((item, idx) => (
                      <li key={idx} className="flex items-baseline gap-2.5">
                        <span className="font-semibold text-lime-700 shrink-0">{idx + 1}.</span>
                        <span>{item}</span>
                      </li>
                    ))}
                  </ol>

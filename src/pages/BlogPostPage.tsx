      ...
      <section className="relative min-h-[48vh] sm:min-h-[52vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-[#0A0A0A]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-6">
          ...
          >
            ...
            <span>/</span>
            <span className="text-white font-medium">Detalle del Artículo</span>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 sm:mb-10">
            ...
            >
              ...
              <span>Volver a Noticias & Artículos</span>
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            >
              ...
              <div className="bg-zinc-100 border border-zinc-200 rounded-2xl sm:rounded-3xl p-6 sm:p-7 space-y-4">
                ...
                <div className="space-y-3.5 pt-1 text-xs sm:text-sm font-light text-zinc-700">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-zinc-900 font-medium">
                      <Tag className="w-4 h-4 text-zinc-700 shrink-0" />
              ...
              {post.author && (
                <div className="bg-[#FAFAFA] border border-zinc-200 rounded-2xl sm:rounded-3xl p-6 sm:p-7 shadow-sm space-y-4">
                  <h3 className="text-lg font-medium text-black tracking-tight">
                    Autor
                  </h3>
                  ...
                  <div className="flex items-center gap-3.5">
                    <img 
                      ...
                      className="w-12 h-12 rounded-full object-cover ring-2 ring-zinc-400 shrink-0"
                    />

...
export const ServiceDetailPage: React.FC = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hola, me gustaría solicitar información y asesoría sobre el servicio "${service.title}" de Golden Inmobiliaria.`
  );
      ...
      <section className="relative min-h-[48vh] sm:min-h-[52vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-[#1D4263]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-6">
          ...
          >
            ...
            <span>/</span>
            <span className="text-amber-400 font-medium">Detalle del Servicio</span>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            >
              ...
              <motion.a 
                ...
                className="inline-flex items-center gap-2 bg-#E5A020 hover:bg-#E5A020 text-white text-xs sm:text-sm font-medium px-6 py-2.5 rounded-full transition-all shadow-sm"
              >
          ...
          <div className="mt-20 sm:mt-28 pt-12 sm:pt-16 border-t border-slate-200">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 sm:mb-12 gap-4">
              <div>
                <span className="text-xs font-medium text-#E5A020 uppercase tracking-wider block mb-1">
                  NUESTROS SERVICIOS
                </span>
              ...
              <Link 
                to="/servicios"
                className="inline-flex items-center gap-2 bg-#E5A020 hover:bg-#E5A020 text-white font-medium text-xs sm:text-sm px-5 py-2.5 rounded-full transition-all shadow-sm self-start sm:self-auto"
              >
              ...
              {otherServices.map((otherServ, idx) => (
                ...
                >
                  ...
                  <Link to={`/servicios/${otherServ.id}`} className="block relative aspect-[16/11] rounded-2xl overflow-hidden shadow-sm bg-slate-100">
                    ...
                    <div className="absolute bottom-3 right-3 w-10 h-10 rounded-xl bg-#E5A020 text-white flex items-center justify-center shadow-lg group-hover:bg-#E5A020 transition-colors">
                  ...
                  <div className="pt-4">
                    <Link to={`/servicios/${otherServ.id}`}>
                      <h3 className="text-lg font-medium text-slate-900 group-hover:text-amber-600 transition-colors mb-1.5 leading-snug">
                        {otherServ.title}
                      </h3>
                    </Link>

...
export const HeroSection: React.FC = () => {
  const fullText = "El Departamento de Tus Sueños Se Hace Realidad";
  ...
  return (
    <section className="relative min-h-[100dvh] min-h-screen flex items-center justify-center pt-24 sm:pt-28 pb-12 sm:pb-16 overflow-hidden bg-[#0A0A0A]">
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="visible"
        className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mt-4 sm:mt-8 flex flex-col justify-between"
      >
        <div className="max-w-3xl">
          ...
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/10 border border-white/15 text-zinc-300 text-[11px] font-medium uppercase tracking-widest mb-4 sm:mb-6 backdrop-blur-md"
          >
            <span>ESPECIALISTAS EN VENTA DE DEPARTAMENTOS</span>
          </motion.div>
        ...
        <motion.div 
          variants={itemVariants}
          className="mt-4 sm:mt-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4 sm:gap-6 pt-2 sm:pt-4"
        >
          
          {/* Left Actions: Minimalist Property Card + WhatsApp CTA */}
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            
            {/* Minimalist Property Preview Card */}
            <Link 
              to="/propiedades/prop-1"
              className="bg-[#141414]/80 backdrop-blur-md border border-white/15 rounded-2xl p-2.5 sm:p-3 flex items-center gap-3 shadow-2xl hover:bg-[#1C1C1C] hover:border-white/30 transition-all group max-w-full"
            >
              <img 
              ...
              <div className="pr-2 overflow-hidden">
                <span className="text-[9px] sm:text-[10px] font-semibold text-zinc-400 uppercase tracking-widest block">DEPARTAMENTO DESTACADO</span>
              ...
              <div className="w-8 h-8 rounded-full bg-white/10 group-hover:bg-white group-hover:text-black text-white flex items-center justify-center transition-colors shrink-0 ml-auto">
            ...
            <a 
              ...
              className="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white border border-white/15 rounded-full px-5 py-2.5 text-xs sm:text-sm font-medium transition-all flex items-center gap-2 shadow-sm"
            >
          ...
          {/* Right Side: Circular Sleek Action Button */}
          <a 
            href="#deals"

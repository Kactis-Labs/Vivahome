      ...
      >
        <div className="max-w-3xl">
          ...
          <h1 className="text-3xl sm:text-5xl lg:text-7xl font-normal text-white tracking-[-0.035em] leading-[1.14] mb-4 sm:mb-6 min-h-[2.4em]">
            ...
            <span 
              className={`inline-block w-[2.5px] sm:w-[3px] h-7 sm:h-11 lg:h-14 bg-[#1E8E5A] ml-1.5 align-middle transition-opacity duration-300 ${
          ...
          <motion.p 
            ...
            className="text-sm sm:text-base lg:text-lg text-zinc-100 font-light leading-relaxed mb-6 sm:mb-10 max-w-2xl"
          >
            Disfruta de la tranquilidad de la naturaleza en Puerto Malabrigo y Ascope - La Libertad. Lotes al contado desde <strong className="font-semibold text-emerald-400">S/ 14,900</strong> con 100% financiamiento directo sin bancos, solo con tu DNI.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            ...
            >
              ...
              <div className="pr-2 overflow-hidden">
                <span className="text-[10px] sm:text-[11px] font-bold text-emerald-400 uppercase tracking-wider block">DESDE S/ 14,900 AL CONTADO</span>
              ...
              <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#1E8E5A] text-white flex items-center justify-center transition-colors shrink-0 ml-auto sm:ml-1 group-hover:bg-emerald-500">
                <ArrowUpRight className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              </div>
            </Link>

            {/* WhatsApp CTA sin marco */}
            <a 
              ...
              className="bg-white/15 hover:bg-white/25 backdrop-blur-md text-white rounded-full px-5 py-2.5 text-xs sm:text-sm font-medium transition-all flex items-center gap-2 shadow-lg"
            >
          ...
          <a 
            href="#deals"
            className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#1E8E5A] hover:bg-emerald-500 text-white flex items-center justify-center shadow-xl shadow-black/40 transition-transform hover:scale-105 self-end sm:self-auto shrink-0"

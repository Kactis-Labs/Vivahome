  ...
  return (
    <section className="relative min-h-[100dvh] min-h-screen flex items-center justify-center pt-28 sm:pt-32 pb-12 sm:pb-16 overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Gradiente blanco con intensidad desde la izquierda */}
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 max-w-2xl">
            ...
            >
              ...
              <Link 
                ...
                className="bg-white hover:bg-zinc-50 text-zinc-800 rounded-full px-6 py-3.5 text-xs sm:text-sm font-medium transition-colors flex items-center gap-2 shadow-sm border border-zinc-200"
              >
          ...
          {/* Right Column: Logo del proyecto y texto estáticos sin animación flotante */}
          <motion.div 
            variants={itemVariants}
          ...
          >
            <div className="flex flex-col items-center select-none">
              ...
              />
              <span className="text-xs sm:text-sm lg:text-[15px] font-black tracking-[0.22em] text-[#1D4263] uppercase block mt-3 text-center drop-shadow-sm font-sans">

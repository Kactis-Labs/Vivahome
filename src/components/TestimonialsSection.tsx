      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xs sm:text-base font-light text-zinc-600 leading-relaxed">
            Conoce la experiencia de inversionistas y propietarios que confiaron en la asesoría de GyS Servicios Inmobiliarios.
          </p>
        </motion.div>
          ...
          {testimonials.map((t, index) => {
            ...
            return (
              <motion.div
                ...
                className={`bg-white border border-zinc-200 rounded-3xl p-6 sm:p-7 shadow-sm hover:shadow-md hover:border-lime-500/40 transition-all flex flex-col justify-between ${
              ...
              >
                ...
                <div className="flex items-center gap-3.5 pt-4 border-t border-zinc-100">
                  <img 
                    src={t.avatar} 
                    alt={t.name} 
                    className="w-11 h-11 rounded-full object-cover ring-2 ring-lime-400"
                  />
                  <div>

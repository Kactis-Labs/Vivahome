...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#0D2218] text-white pt-16 sm:pt-20 pb-12">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a 
                ...
                className="w-9 h-9 rounded-full bg-white/5 hover:bg-[#1E8E5A] hover:text-white flex items-center justify-center text-zinc-300 transition-colors"
                aria-label="Facebook"
              >

...
export const FaqSection: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-16 sm:py-24 bg-[#111827] text-white border-t border-white/10 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-start">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white mb-3 sm:mb-6 leading-tight">
              Todo lo que Necesitas Saber Sobre Tu Inmueble
            </h2>

            <p className="text-slate-300 text-xs sm:text-sm font-normal leading-relaxed mb-6 sm:mb-8">
              Resolvemos tus consultas sobre compraventa, documentación para vender, estudio de títulos en Sunarp y visitas guiadas con <strong className="text-white font-semibold">Inmobiliaria JML</strong> en Trujillo.
            </p>
            ...
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border border-white/10 hidden sm:block">
              <img 
                ...
                alt="Propiedad en Trujillo - Inmobiliaria JML" 
              ...
              <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6 flex items-center justify-between text-white">
                <div>
                  <h4 className="text-xs sm:text-sm font-bold">¿Tienes una consulta específica?</h4>
                  <p className="text-[11px] sm:text-xs font-normal text-slate-300">Habla con un asesor por WhatsApp</p>
                </div>
                <motion.a 
                  whileHover={{ scale: 1.08 }}
                  whileTap={{ scale: 0.95 }}
                  href="https://wa.me/51987654321?text=Hola,%20tengo%20una%20consulta%20para%20Inmobiliaria%20JML%20en%20Trujillo"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#DC2626] text-white flex items-center justify-center shrink-0 hover:bg-[#B91C1C] transition-colors shadow-md"
                >
              ...
              return (
                <motion.div 
                  ...
                  className={`rounded-2xl border transition-all duration-300 overflow-hidden ${
                    isOpen 
                      ? 'bg-[#1F2937] border-[#DC2626]/60 shadow-md' 
                      : 'bg-[#161F2E] border-white/10 hover:border-white/20'
                  }`}
                >
                  <button
                  ...
                  >
                    ...
                    <div className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center shrink-0 transition-colors duration-200 ${
                      isOpen ? 'bg-[#DC2626] text-white' : 'bg-white/10 text-white'
                    }`}>
